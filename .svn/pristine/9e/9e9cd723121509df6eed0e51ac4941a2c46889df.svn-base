  ...
  <div>
    <el-form ref="formValidate" :model="formValidate" class="nosocomial" label-width="110px">
      ...
      <el-form-item label="新建类别：" prop="categoryCode">
        ...
        <el-radio v-if="tkType !== 'EXAM_PAPER'" v-model="formValidate.treeDes" label="QUESTION" @change="treeDesChange">新建题组</el-radio>
      </el-form-item>
      ...
      <el-form-item v-if="tkType !== 'TK' && tkType !== 'ORG_SELF_TK' && tkType !== 'PAPER' && formValidate.treeDes === 'QUESTION'" label="选择试题：" prop="categoryCode">
...
export default {
  ...
  created () {
    ...
    if(this.operailityType === 'edit') {
      ...
      this.formValidate.path = this.operailityData.path.slice(0, this.operailityData.path.length - 7) + this.operailityData.id + ','
