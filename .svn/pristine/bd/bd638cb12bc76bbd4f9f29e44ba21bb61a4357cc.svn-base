...
<template>
  <div>
    <el-form :model="formData"  ref="formData" :rules="rules"   class="demo-form-inline"  label-width="80px" >
       <el-row >
       ...
       <el-row >
        <el-col :span="20" :offset="2">
          <el-form-item label="知识分级" prop="level">
            <el-input-number v-model="formData.level" style="width: 100%"></el-input-number>
          </el-form-item>
        </el-col >
      </el-row >
    </el-form>
        ...
        this.$refs["formData"].validate(valid => {
          if(valid){
            let opt = {
              ...
              ajaxParams: {
                url: this.knowledgeApi.addKnowledgeConfig.path,
                method: this.knowledgeApi.addKnowledgeConfig.method,
                jsonString: true,
                data: this.formData
              }
            }
