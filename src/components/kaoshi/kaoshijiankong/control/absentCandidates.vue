<template>
  <div ref="content">
    <el-row style="margin-bottom:20px">
      ...
      <el-col align="left" style="width:70px;float:left;margin-left:10px;">
...
<!--    <table border="1" height="60px">
      <tr>
        ...
        <td width="300px">
          {{ operailityData.paperConversion100 * 0.6}}/{{operailityData.paperConversion100}}
        </td>
      </tr>
      <tr>
        <td width="100px" style="background-color:#f2f2f2">
      ...
      <el-table :data="tableData" style="width: 100%" border :height="dynamicHt">
        ...
        <el-table-column prop="hasSigned" label="是否签到">
          <template slot-scope="scope">
            <span>{{ scope.row.hasSigned === false?'否': '是' }}</span>
          </template>
        </el-table-column>
      </el-table>
    </div>
    ...
    <Modal :mask-closable="false" height="200" v-model="exportModal"
      ...
      <ajaxDerive v-if="exportModal" type='excel' fileName='缺席考生' :url="'/mark/admin/examMark/console/exportMissExam'"
       :params="params" messTitle="确定要导出到excel吗？"
