    ...
    <el-form :model="formValidate1"  ref="formValidate" :rules="rules"   class="demo-form-inline"  label-width="100px" >
       <el-row >
        <el-col :span="20" :offset="2">
          <el-form-item label="知识库_内容IDS" prop="knowledgeContentIds">
             <el-input type="textarea" resize="none" :rows="5" v-model="formValidate1.knowledgeContentIds"></el-input>
          </el-form-item>
        </el-col >
      </el-row >
       <el-row >
  ...
  export default {
    ...
    data (){
      return{
        ...
        rules: {
         	knowledgeContentIds:[
         	{ max: 65535, message: '长度最多65535个字符', trigger: 'blur' }
         	],
         	creator:[
